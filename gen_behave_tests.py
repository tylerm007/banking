...
class GenBehaveTests:
    ...
    def __init__(self, repos_path: str, project_name: str,project_directory: str, table_to_class: dict, section: str = 'all', api_url:str = "", version: str = '5.4'):
        self.repos_path = repos_path
        self.project_directory = project_directory
        self.project_name = project_name
        self.table_to_class:dict = table_to_class
        self.section = section 
        self.version = version or "5.4"
        self.api_url = f"{api_url}"
        self.host = host or "localhost"
        self.port = port or 5656
        self.api = api or "api"
        self.list_of_tables = table_to_class # self.get_list_of_tables()
        self._content = ""
    
    def append_content(self, content: str, project_directory: str):
        file_name = f"{project_directory}" #get_os_url(f'{project_directory}')
    ...
    def print_meta(self, meta):
        #self.add_content("\n\nmeta.sorted_tables (meta = metadata.sorted_tables)\n")
...
def main():
    ...
    gbt = GenBehaveTests(repos_path="", project_name="banking", project_directory="/Users/tylerband/dev/ApiLogicServer/banking", table_to_class=tables_to_class)
    gbt.start()
